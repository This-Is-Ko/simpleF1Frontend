...
function ConstructorsChampionshipTable(props) {
    return (
                ...
                <Table sx={{ minWidth: 300 }} stickyHeader size="small" aria-label="simple table">
                    ...
                    {props.constructorsStandings.map((constructorEntry) => (
                        ...
                        <TableCell align="center">
                            <img className='team-logo' alt={constructorEntry.teamLogoAlt} src={process.env.PUBLIC_URL + '/assets/logos/' + constructorEntry.teamLogoUri + '.png'}/>
                        </TableCell>
                        <TableCell>{constructorEntry.name}</TableCell>
                        <TableCell align="right">{constructorEntry.points}</TableCell>
                        </TableRow>
                    ))}
                    </TableBody>
                </Table>
...
export default ConstructorsChampionshipTable;